  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div
          className="group relative overflow-hidden rounded-xl cyberpunk-card transition-all duration-300 hover:scale-[1.05] cursor-pointer w-full max-w-[500px] min-h-[600px]"
